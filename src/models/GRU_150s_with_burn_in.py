...
def train_model():
    ...
    train_dir = os.path.join(data_dir, "data_in_150s_with_burn_in")
    test_dir = os.path.join(data_dir, "test_in_150s_with_burn_in")
...
def test_model(model, test_datasets):
    ...
    script_dir = os.path.dirname(os.path.abspath(__file__))
    output_dir = os.path.join(script_dir, "GRU_with_burn_in")
